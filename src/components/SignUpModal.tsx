...
const SignUpModal: React.FC<SignUpModalProps> = ({ open, onClose, onShowLogin }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative animate-fade-in">
        ...
        <p className="text-gray-500 mb-6 text-center">Sign up for Linkria using your Google account</p>
        ...
        <div className="text-center text-sm text-gray-500">
          ...
          <button 
            ...
            style={{ color: '#5E936C' }} 
            onClick={() => { setError(null); onClose(); onShowLogin(); }}
          >
            Log in
          </button>
        </div>
